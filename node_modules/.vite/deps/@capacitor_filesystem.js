...
var Filesystem = registerPlugin("Filesystem", { web: () => import("./web-B_JAPfM0.js").then((m) => new m.FilesystemWeb()) });
f();
//#endregion
export { Directory, Encoding, Filesystem, FilesystemDirectory, FilesystemEncoding };
